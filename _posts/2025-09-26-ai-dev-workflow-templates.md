---
layout: post
title: Open Sourcing My AI Development Workflow Templates
...
- **`001_task_planning_template.md`** → a systematic framework for planning and executing projects with AI assistance  
- **`002_bug_fix_template.md`** → a structured approach to analyzing and resolving bugs  
- **`003_code_review_template.md`** → a comprehensive template for running consistent code reviews  
- **`004_git_commit_workflow.md`** → a workflow for writing clear and conventional git commits  
...
👉 [ai-dev-workflow-templates on GitHub](https://github.com/DamiMartinez/ai-dev-workflow-templates)
